...
function App() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "App", children: [(0, jsx_runtime_1.jsx)("h1", { children: "Todo" }), (0, jsx_runtime_1.jsx)(exports.TodoStateContext.Provider, { value: todos, children: (0, jsx_runtime_1.jsxs)(exports.TodoDispatchContext.Provider, { value: { onClickAdd: onClickAdd, onClickDelete: onClickDelete }, children: [(0, jsx_runtime_1.jsx)(Editor_1.default, {}), (0, jsx_runtime_1.jsx)("div", { children: todos.map(function (todo) { return ((0, jsx_runtime_1.jsx)(TodoItem_1.default, __assign({}, todo), todo.id)); }) })] }) })] }));
}
exports.default = App;
